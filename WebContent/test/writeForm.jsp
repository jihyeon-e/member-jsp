...
<meta charset="UTF-8">
<title>회원가입</title>
<link rel="stylesheet" href="main.css"> <!--main.css로 연결 -->
</head>
<body style="background: linear-gradient(to right, #e89eb4, #f2e9de);">

  <form name="writeForm" method="post" action="">
 
  <div id="writeFormHeader">
  ...
  <div id="writeFormContainer">
	<table cellpadding="5" cellspacing="0">
	 ...
	 <tr>
	 	...
	 	<td>
	 		<input type="text" name="name" placeholder="이름 입력(필수)">
	 		<div id="nameDiv"></div>
	 	</td>
	 </tr>
	 ...
	 <tr>
	 	...
	 	<td>
	 		<input type="password" name="pwd" placeholder="비밀번호 입력(필수)">
	 		<div id="pwdDiv"></div>
	 	</td>
	 </tr>
